...
let rec hasSynchronousComponents graph : bool =
    ...
    |> Map.map (fun compId comp ->
            ...
            | Xor | Nand | Nor | Xnor | Mux2 | Demux2 | NbitsAdder _
            | NbitsNot _ | NbitsAnd _ | NbitsOr _ | NbitsXor _ | NbitsNand _ | NbitsNor _ | NbitsXnor _
            | Decode4 | AsyncROM1 _ | Constant1 _ | Viewer _ -> false
